    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        try:
            ...
            # TODO: 3.3. Sync the /pose and /cmd_vel subscribers if enable_localization is True.
                ...
                self._s = message_filters.ApproximateTimeSynchronizer(
                    self._subscribers, queue_size=10, slop=20
                )
                self._s.registerCallback(self._next_step_callback)
            ...
            self._laser_scan_publisher = (
                self.create_publisher(  # medida de haces del lidar en un instante de tiempo
